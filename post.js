        ...
        if (posts.length === 0) {
          ...
          posts.forEach((post) => {
            ...
            row.innerHTML = `
              ...
              <td>
                <div class ="d-flex ">
                  <button class="btn btn-info" onclick='handleEditpost(${JSON.stringify(post)})'>Edit</button>
                  <button class="btn btn-danger mx-3" onclick='handleDeletepost(${post.id})'>Delete</button>
                </div>
              </td>
            `;
